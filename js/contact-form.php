...
$e_subject = 'Zgłoszenie dziecka do klubu';
...
$e_reply = " Adres email opiekuna: $email ".PHP_EOL." <br> Telefon opiekuna: $phone <br> Poprzedni klub: $club <br> Zgoda: $redo".PHP_EOL;
