...
if(trim($c_name) == '') {
	...
	exit();
} else if(!isEmail($c_email)) {
	echo '<div class="error_message">Podaj poprawny adres e-mail.</div>';
	exit();
}

if(get_magic_quotes_gpc()) {
	$c_comments = stripslashes($c_comments);
}
...
$e_subject = 'Zapytanie z formularza kontaktowego';

// Configuration option.
// You can change this if you feel that you need to.
// Developers, you may wish to add more fields to the form, in which case you must be sure to add them here.

$e_body = "Imię i nazwisko: $c_name <br>" . PHP_EOL . PHP_EOL;
$e_content = "Adres e-mail: $c_email <br>Telefon: $c_phone <br>Temat wiadomości: $c_topic <br>"  . PHP_EOL . PHP_EOL;
$e_reply = "Treść wiadomości: $c_comments<br>Zgoda: $c_redo".PHP_EOL;
